...
let colors_name = "herald_JeffCustom"
...
if has("gui_running")
	...
	" -> Code
	hi Comment        guibg=#1F1F1F guifg=#20b2aa gui=none
...
elseif &t_Co == 256
	...
	"hi PmenuSel       ctermbg=208  ctermfg=52    cterm=none
	hi Pmenu          ctermbg=244  ctermfg=253    cterm=none
	hi PmenuSel       ctermbg=29   ctermfg=0    cterm=none
	hi PmenuSbar      ctermbg=247                 cterm=none
